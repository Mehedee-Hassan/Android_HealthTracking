...
public class GraphView extends View
{
	...
	public void plotProcedure(int data) {
		...
		if (counter == 0) { path.moveTo(0, 100 - data);} else {
			path.lineTo( counter*spacing, 100 - data);
		}
		counter++;
		// Force redraw
		invalidate();
    ...
    public void onDraw(Canvas canvas)
    {
		...
		canvas.drawText(String.valueOf(data), availableWidth/2, availableHeight/2, paint);
