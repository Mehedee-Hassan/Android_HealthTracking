 ...
 */
public class BPFragmentDum extends Fragment implements FragmentView {
...
//                    params.put("data", mStringBuilder.toString());
                    params.put("data", singleValue);
                    params.put("sensor_type", ConstantValues.SENSOR_BLOOD_PRESSURE);
                    params.put("userid", "1");
                    new AllFragmentPresenter(BPFragmentDum.this).postData("sensors/save_data_from_app", params);


                } else {
                    Map<String, String> params = new HashMap<>();
                    params.put("patient_id", "1");
                    new AllFragmentPresenter(BPFragmentDum.this).getApiData("sensors/view_sensors_data_api/" + mPatientId + "/" + ConstantValues.SENSOR_BLOOD_PRESSURE, params);
